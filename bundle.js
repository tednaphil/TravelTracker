...
function renderDom(userID) {
  ...
  let organizedTrips = (0,_trips__WEBPACK_IMPORTED_MODULE_1__.organizeTrips)(trips, destinationsData);
  let tripDisplayDetails = (0,_trips__WEBPACK_IMPORTED_MODULE_1__.getTripDisplayInfo)(organizedTrips);
...
function checkTripDate() {
  const userTrips = (0,_trips__WEBPACK_IMPORTED_MODULE_1__.filterTrips)(currentTraveler, tripsData);
...
function organizeTrips(userTrips, destinationsArray) {
  userTrips.forEach(trip => {
    trip.destination = (0,_destinations__WEBPACK_IMPORTED_MODULE_0__.findDestination)(trip.destinationID, destinationsArray)
  })
...
function getTripDisplayInfo({ approved, pending }) {
  const allDisplayInfo = {
    past: approved.length
      ? approved.map((trip) => (0,_destinations__WEBPACK_IMPORTED_MODULE_0__.getDestDisplayInfo)(trip))
      : "No Trips 🌍",
    pending: pending.length
      ? pending.map((trip) => (0,_destinations__WEBPACK_IMPORTED_MODULE_0__.getDestDisplayInfo)(trip))
      : "No Pending Trips 🌍",
  };
